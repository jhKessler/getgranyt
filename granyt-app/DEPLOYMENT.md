...
3. **Run Migrations:** You must run the migrations image as an init container once before the `latest`.
4. **Database:** Granyt expects a PostgreSQL database. Ensure `DATABASE_URL` is correctly configured.
