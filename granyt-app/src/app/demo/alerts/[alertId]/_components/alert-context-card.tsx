        ...
        <div className="space-y-2">
          <ContextRow label="DAG">
            <Button 
              ...
              onClick={() => router.push(`/demo/dags/${encodeURIComponent(alert.srcDagId)}`)}
            >
              {alert.srcDagId}
          ...
          <div className="bg-muted/50 border border-border rounded-lg p-3 my-2">
            ...
            <Button 
              variant="link" 
              className="h-auto p-0"
              onClick={() => router.push(`/demo/dags/${encodeURIComponent(alert.srcDagId)}/runs/${encodeURIComponent(alert.dagRunId)}`)}
            >
