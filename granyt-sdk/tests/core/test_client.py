...
class TestSendTaskEvents:
    ...
    def test_send_task_complete_clears_run_id(self, valid_env, mock_task_instance):
        ...
        cache_key = f"{mock_task_instance.dag_id}.{mock_task_instance.task_id}.{mock_task_instance.run_id}"
        run_id = client.get_or_create_run_id(
            mock_task_instance.dag_id,
            mock_task_instance.task_id,
            mock_task_instance.run_id
        )
